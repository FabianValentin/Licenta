...
public class JwtTokenUtil implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3224912523924163209L;
	...
	private boolean isTokenExpired(String token) {
		final Date expiration = getExpirationDateFfromToken(token);
		return expiration.before(new Date());
	}

	private Date getExpirationDateFfromToken(String token) {
